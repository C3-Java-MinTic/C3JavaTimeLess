...
public class MovimientoDineroController {
    ...
    private MovimientoDineroService movimientoDineroService;
     ...
     public RedirectView insertarMovimientos(@ModelAttribute MovimientoDinero movimientoDinero, Model modelo){
     ...
     modelo.addAttribute(movimientoDinero);
     if (movimientoDineroService.crearNuevoMovimiento(movimientoDinero).equals(Boolean.TRUE)){
        return new RedirectView("/vermovimientos");
